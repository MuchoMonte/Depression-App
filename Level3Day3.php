...
<div id="Content">
	<div id="PageHeading">
	  <h1>Level 3 - Bonding</h1>
	</div>
	<div id="ContentLeft">
	  <h2>Bonding with Family and Friends</h2>
	  <h6>&nbsp;</h6>
	  <h6>For this step, we invite you to reflect on the time spent with your loved ones.</h6>
	</div>
    <div id="ContentRight">
      <form action="<?php echo $editFormAction; ?>" id="Level1Day1Form" name="Level1Day1Form" method="POST">
        <table width="200" border="0" align="center">
          <tbody>
            <tr>
              <th class="StyleTxtField" scope="col"><p>Time Spent with Loved Ones:</p>
              <p>
                <input name="textfield" type="text" class="StyleTxtField" id="textfield">
              </p></th>
            </tr>
            <tr>
              <th class="StyleTxtField" scope="row"><p>Time you wish you had spent with Loved Ones:</p>
              <p>
                <input name="textfield2" type="text" class="StyleTxtField" id="textfield2">
              </p></th>
            </tr>
            <tr>
              <th align="center" class="StyleTxtField" scope="row"><p>What could you do to make more time for your Loved Ones:</p>
                <p>
